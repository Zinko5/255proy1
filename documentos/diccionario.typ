#import "apuntesPlantillaT.typ": config, separador
...
#table(
  ...
  table.header([*Variable*], [*Descripción*], [*Tipo*]),
  ...
  [`visionScore`],
  [Puntuación que mide la contribución a la visión del mapa (centinelas, destrucción, etc.)],
  [Integer],
  ...
  [Porcentaje de muertes enemigas en las que el jugador participó (K+A) / Total Kills Equipo],
  [Float],

  [`challenge_laningPhaseGoldExpAdvantage`],
  [Ventaja de recursos (oro/experiencia) obtenida frente al oponente directo en fase de líneas],
  [Float],
